...
<div className='flex items-center justify-center sm:w-full w-screen mx-auto p-4  '>
  <div className={`mx-auto w-screen sm:w-full  bg-white rounded-xl p-4 border border-black  `}>
