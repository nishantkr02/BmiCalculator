...
function WeightLoss() {
  ...
  return (
    <div className='flex flex-col w-screen p-4 sm:w-3/4  px-2 mx-auto  border sm:px-6 my-1 shadow-2xl rounded bg-white'>

     <div className=' flex flex-col  justify-between mx-auto w-screen p-4 sm:w-full  '>
            ...
            <div className=' flex flex-row w-full  justify-center   mx-auto  py-2 px-1 h-20 mt-2 '>
             ...
             <div className='w-full flex flex-col h-auto   mt-4'>
                ...
                <div className='flex flex-wrap h-auto w-full p-2 '>
                  ...
                  <p className=' flex justify-start text-sm sm:text-lg font-medium text-gray-600 mb-2 underline'>Physical Health Benefits </p>
